...
public class WeiboStatusesFriendsTimeline {
    
    static String friends_timeline = "https://api.weibo.com/2/statuses/friends_timeline.json";

    public static void main(String[] args) throws IOException {
        
        WebClient wc = WebClient.create(friends_timeline);
