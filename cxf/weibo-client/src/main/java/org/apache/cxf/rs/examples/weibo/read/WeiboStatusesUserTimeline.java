...
public class WeiboStatusesUserTimeline {
    
    static String user_timeline = "https://api.weibo.com/2/statuses/user_timeline.json";

    public static void main(String[] args) throws IOException {

        WebClient wc = WebClient.create(user_timeline);
