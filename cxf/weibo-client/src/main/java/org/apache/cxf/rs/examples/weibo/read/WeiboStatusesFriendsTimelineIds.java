...
public class WeiboStatusesFriendsTimelineIds {
    
    static String friends_timeline_ids = "https://api.weibo.com/2/statuses/friends_timeline/ids.json";

    public static void main(String[] args) throws IOException {

        WebClient wc = WebClient.create(friends_timeline_ids);
