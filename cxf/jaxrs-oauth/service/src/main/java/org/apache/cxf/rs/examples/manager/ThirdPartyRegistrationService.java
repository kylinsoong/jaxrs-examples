package org.apache.cxf.rs.examples.manager;
...
import org.apache.cxf.rs.examples.ConsumerRegistration;
...
public class ThirdPartyRegistrationService {
	...
	private Map<String, CachedOutputStream> appLogos = new HashMap<String, CachedOutputStream>();
