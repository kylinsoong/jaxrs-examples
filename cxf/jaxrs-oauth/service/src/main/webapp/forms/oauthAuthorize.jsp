       ...
       <tr align="center">
                <td>
                    ...
                    <form action="<%= data.getReplyTo() %>" method="POST">
                        <input type="hidden" name="oauth_token" value="<%= data.getOauthToken() %>"/>
                        <input type="hidden" name="<%= org.apache.cxf.rs.security.oauth.utils.OAuthConstants.AUTHENTICITY_TOKEN %>" value="<%= data.getAuthenticityToken() %>"/>
                        ...
                        <br/></p><br/>
                        <button name="<%= org.apache.cxf.rs.security.oauth.utils.OAuthConstants.AUTHORIZATION_DECISION_KEY %>" type="submit" value="<%= org.apache.cxf.rs.security.oauth.utils.OAuthConstants.AUTHORIZATION_DECISION_ALLOW %>">
                            OK
                        </button>
                        <button name="<%= org.apache.cxf.rs.security.oauth.utils.OAuthConstants.AUTHORIZATION_DECISION_KEY %>" type="submit" value="<%= org.apache.cxf.rs.security.oauth.utils.OAuthConstants.AUTHORIZATION_DECISION_DENY %>">
                            No,thanks
                        </button>
